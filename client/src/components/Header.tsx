                ...
                <div className="flex items-center gap-4 h-16">
                    ...
                    <div className="flex items-center gap-3 ml-auto">
                        <button
                            ...
                            aria-label={itemCount > 0 ? 'Open cart' : 'Open cart (empty)'}
                            title={itemCount > 0 ? 'Open cart' : 'Your Cart is Empty'}
                        >
                            <svg
                                className="w-6 h-6"
                                fill="none"
                        ...
                        <button
                            ...
                            className="lg:hidden flex items-center justify-center w-10 h-10 rounded-lg hover:bg-gray-50 text-gray-700 hover:text-gray-900"
                            aria-label="Search"
                        >
                            <svg
                                className="w-5 h-5"
                        ...
                        <div className="flex items-stretch w-full">
                            <div className="relative flex-1">
                                <input
                                    ...
                                    onChange={(e) => setSearchValue(e.target.value)}
                                    placeholder="Search products, brands and more"
                                    className="w-full h-10 px-4 border border-gray-300 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500 text-sm"
                                />
                                {searchValue.trim().length > 0 && (
                                    <button
                                        type="button"
                            ...
                            <button
                                ...
                                className="ml-2 h-10 px-3 rounded-lg border border-gray-300 bg-white text-sm font-semibold text-gray-800"
                            >
                                Done
                            </button>
                        </div>
